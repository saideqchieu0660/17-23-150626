      ...
      <AnimatePresence>
        {user && (
          <motion.nav 
            ...
            className="md:hidden fixed bottom-0 w-full z-40 glass rounded-none border-t border-white/20 dark:border-white/10 pt-3 pb-6 flex justify-around items-center pl-2 pr-[4.5rem]"
          >
            {(() => {
