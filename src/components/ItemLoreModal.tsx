...
export const ITEM_LORES: Record<string, ItemLore> = {
  ...
  "achilles_heel": {
    ...
    uiDescription: "Giao kèo cực đoan với ranh giới cái chết. Thu hoạch nhân ba, sụp đổ tức khắc nếu lơ là.",
    appFunction: "Cung cấp hệ số XP nhân x3 cực hạn (High-risk buff) xuyên suốt quá trình học. Tuy nhiên, nếu trả lời sai một câu duy nhất hoặc tụt một ngày học, chuỗi Streak lẫn một số cấp độ bị thiêu rụi ngay lập tức."
  },
  "odins_eye": {
    id: "odins_eye",
